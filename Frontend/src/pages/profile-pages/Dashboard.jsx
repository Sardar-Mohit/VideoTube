          ...
          <div className="flex flex-wrap justify-between gap-4">
            ...
            <div className="block">
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-x-2 bg-[#ae7aff] px-3 py-2 font-semibold text-black"
              >
                <svg
                  ...
                  {videos.map((video) => (
                    ...
                    >
                        ...
                        <div className="flex justify-center">
                          ...
                          >
                            <input
                              ...
                              onChange={() => publishFunc(video._id)}
                      ...
                      <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                        <div className="flex justify-center">
                          {video.isPublished ? (
                            <span className="inline-block rounded-2xl border border-green-600 px-1.5 py-0.5 text-green-600">
                              Published
                            </span>
                          ) : (
                            <span className="inline-block rounded-2xl border border-orange-600 px-1.5 py-0.5 text-orange-600">
                              Unpublished
                            </span>
                          )}
                        </div>
                      ...
                      {/* Date */}
                      <td className="relative left-[4.5%] border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
